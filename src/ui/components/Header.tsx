  ...
  return (
    <div class={styles.header}>
      <div class={styles.logo}>
        <HomeToGoMark />
        <span class={styles.logoDivider}>·</span>
